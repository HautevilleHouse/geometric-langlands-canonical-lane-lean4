/-!
# Source package model for `geometric-langlands-canonical-lane`
...
def sourceCheckoutHead : String := "f455fb8a6497568e564b04cac1ba0f0ad106c4e5"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/geo_closure_guard.py", sha256 := "a7e3afcbb0695aa721c53f21103176042eefe748c5d7a08e0866af9bb3b140b3", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/geo_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 19, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "_resolve", args := ["p"], returns := "Path", doc := "", line := 22, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "_bootstrap", args := ["path"], returns := "None", doc := "", line := 25, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "_load_registry", args := ["path"], returns := "", doc := "", line := 30, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "_load_sigma", args := ["path"], returns := "", doc := "", line := 36, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "", doc := "", line := 47, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict"], returns := "", doc := "", line := 54, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "", doc := "", line := 77, isAsync := false },
  { file := "scripts/geo_closure_guard.py", name := "main", args := [], returns := "", doc := "", line := 83, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/geo_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 10 },
  { file := "scripts/geo_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 11 },
  { file := "scripts/geo_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_hecke\", \"sigma_local\", \"kappa_compact\", \"rho_rigidity\", \"eigensheaf_transfer\"]", line := 12 },
  { file := "scripts/geo_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 13 },
  { file := "scripts/geo_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 14 },
  { file := "scripts/geo_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 15 },
  { file := "scripts/geo_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 16 },
  { file := "scripts/geo_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 17 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_hecke", status := "derived_numeric", formula := "c_hecke_raw * sheaf_density_raw - e_hecke_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 4.5 / Appendix A", validation := "required_positive", componentKeys := ["c_hecke_raw", "e_hecke_raw", "sheaf_density_raw"] },
  { group := "constants", key := "sigma_local", status := "derived_numeric", formula := "local_floor_raw - satake_loss_raw - restart_loss_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 5.2 / Appendix B", validation := "required_positive", componentKeys := ["local_floor_raw", "restart_loss_raw", "satake_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 5.3 / Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 6.1 / Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "eigensheaf_transfer", status := "derived_numeric", formula := "c_eig_raw * transfer_gain_raw - e_eig_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 6.2 / Appendix E.4", validation := "required_positive", componentKeys := ["c_eig_raw", "e_eig_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Appendix E.6", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eigensheaf_transfer", value := "1.0315400000000001", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eigensheaf_transfer", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 6.2 / Appendix E.4" },
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Appendix E.6" },
  { key := "kappa_compact", value := "0.8038585209003215", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 5.3 / Appendix C" },
  { key := "kappa_hecke", value := "1.0932", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_hecke", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "rho_rigidity", value := "1.078", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 6.1 / Appendix D" },
  { key := "sigma_local", value := "1.0750000000000002", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_local", sourceSection := "paper/GEOMETRIC_LANGLANDS_PREPRINT.md Section 5.2 / Appendix B" }
]

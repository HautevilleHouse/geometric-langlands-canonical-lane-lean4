/-!
# geometric-langlands-canonical-lane Lean migration boundary
...
`GeometricLanglandsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "geometric-langlands-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/geometric-langlands-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Geometric Langlands: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["geometric-langlands", "representation-theory", "algebraic-geometry", "sheaf-theory", "hecke-eigensheaves", "mathematical-proof", "reproducibility", "canonical-lane", "local-to-global", "manifold-constrained"]
